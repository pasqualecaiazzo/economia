...
export const quizQuestions = [
  {
    id: 1,
    type: "mcq",
    question: "Se il prezzo di mercato è sotto il prezzo di equilibrio, cosa osservi?",
    options: ["Eccesso di offerta", "Penuria o eccesso di domanda", "Equilibrio paretiano", "Domanda perfettamente elastica"],
    answer: 1,
    explanation: "Sotto il prezzo di equilibrio i consumatori vogliono comprare più di quanto le imprese offrono."
  },
  {
    id: 2,
    type: "mcq",
    question: "Quale cambiamento provoca un movimento lungo la curva di domanda?",
    options: ["Variazione del reddito", "Variazione dei gusti", "Variazione del prezzo del bene", "Variazione del numero di consumatori"],
    answer: 2,
    explanation: "Solo la variazione del prezzo del bene genera un movimento lungo la curva."
  },
  {
    id: 3,
    type: "mcq",
    question: "La curva di domanda individuale è normalmente:",
    options: ["Crescente", "Decrescente", "Orizzontale", "Verticale"],
    answer: 1,
    explanation: "La legge della domanda lega prezzo e quantità con relazione negativa."
  },
  {
    id: 4,
    type: "mcq",
    question: "Le intercette della retta di bilancio sono:",
    options: ["R/Px e R/Py", "Px/Py e Py/Px", "R x Px e R x Py", "Solo il reddito R"],
    answer: 0,
    explanation: "Le quantità massime acquistabili dei due beni sono R diviso il rispettivo prezzo."
  },
  {
    id: 5,
    type: "mcq",
    question: "Nel punto ottimo del consumatore, con preferenze regolari, avviene:",
    options: ["Intersezione tra due rette di bilancio", "Tangenza tra curva di indifferenza e retta di bilancio", "Massimo prezzo possibile", "Costo marginale uguale a zero"],
    answer: 1,
    explanation: "L'ottimo interno è il punto di tangenza tra preferenze e vincolo."
  },
  {
    id: 6,
    type: "mcq",
    question: "Gli isoquanti rappresentano:",
    options: ["Livelli uguali di utilità", "Livelli uguali di costo", "Livelli uguali di output", "Livelli uguali di profitto"],
    answer: 2,
    explanation: "Ogni isoquanto raccoglie combinazioni di input che producono lo stesso output."
  },
  {
    id: 7,
    type: "mcq",
    question: "Se il salario w aumenta, a parità di tutto il resto, l'isocosto:",
    options: ["Diventa più piatto", "Diventa più ripido", "Si trasforma in una curva", "Non cambia mai"],
    answer: 1,
    explanation: "La pendenza dell'isocosto dipende dal rapporto tra prezzo dei fattori."
  },
  {
    id: 8,
    type: "mcq",
    question: "La condizione generale di massimizzazione del profitto è:",
    options: ["Prezzo = costo medio", "Ricavo totale = costo totale", "Ricavo marginale = costo marginale", "Costo fisso = 0"],
    answer: 2,
    explanation: "Il profitto cresce finché il ricavo marginale supera il costo marginale."
  },
  {
    id: 9,
    type: "mcq",
    question: "In concorrenza perfetta per la singola impresa vale:",
    options: ["P > R'", "P = RM = R'", "P = MC sempre sul mercato", "Domanda inclinata negativamente"],
    answer: 1,
    explanation: "L'impresa price-taker vende al prezzo di mercato, uguale a ricavo medio e marginale."
  },
  {
    id: 10,
    type: "mcq",
    question: "Se per l'impresa concorrenziale il prezzo scende sotto AVC nel breve periodo:",
    options: ["Espande la produzione", "Esce sicuramente per sempre", "Sospende la produzione", "Aumenta il prezzo"],
    answer: 2,
    explanation: "Se non copre nemmeno i costi variabili medi, produrre peggiora la perdita."
  },
  {
    id: 11,
    type: "mcq",
    question: "Il monopolista sceglie prima:",
    options: ["Il prezzo e poi la quantità", "La quantità con MR = MC e poi legge il prezzo sulla domanda", "Il costo medio e poi il prezzo", "Il salario dei lavoratori"],
    answer: 1,
    explanation: "La quantità si trova con MR = MC; il prezzo si ottiene dalla curva di domanda."
  },
  {
    id: 12,
    type: "mcq",
    question: "Quale frase è vera sul ricavo marginale del monopolista?",
    options: ["Coincide sempre con il prezzo", "Sta sopra la domanda", "Sta sotto la domanda", "È sempre nullo"],
    answer: 2,
    explanation: "Per vendere di più il monopolista deve ridurre il prezzo, quindi MR è inferiore al prezzo."
  },
  {
    id: 13,
    type: "mcq",
    question: "Il PIL può essere misurato come:",
    options: ["Solo somma dei salari", "Produzione, spesa o reddito", "Solo valore dei beni intermedi", "Solo spesa pubblica"],
    answer: 1,
    explanation: "Le tre prospettive coincidono per identità contabile."
  },
  {
    id: 14,
    type: "mcq",
    question: "Il valore aggiunto serve a:",
    options: ["Misurare solo i profitti", "Evitare il doppio conteggio", "Calcolare l'inflazione", "Stimare il tasso di cambio"],
    answer: 1,
    explanation: "Conta il contributo netto di ciascuna fase produttiva."
  },
  {
    id: 15,
    type: "mcq",
    question: "Nel mercato del lavoro l'impresa assume finché:",
    options: ["Il prodotto totale cresce", "Il valore del prodotto marginale del lavoro uguaglia il salario", "Il salario è nullo", "La domanda aggregata aumenta"],
    answer: 1,
    explanation: "L'ultimo lavoratore deve almeno coprire il suo costo."
  },
  {
    id: 16,
    type: "mcq",
    question: "Il tasso di interesse reale è approssimativamente:",
    options: ["Nominale + inflazione", "Nominale - inflazione", "Inflazione - nominale", "Nominale x inflazione"],
    answer: 1,
    explanation: "Secondo l'equazione di Fisher, r circa uguale a i meno inflazione."
  },
  {
    id: 17,
    type: "mcq",
    question: "Una recessione è tipicamente associata a:",
    options: ["PIL in crescita e disoccupazione in calo", "PIL in calo e disoccupazione in aumento", "Prezzi fissi e piena occupazione", "Monopolio naturale"],
    answer: 1,
    explanation: "È la dinamica tipica delle fluttuazioni negative di breve periodo."
  },
  {
    id: 18,
    type: "mcq",
    question: "La curva IS riguarda l'equilibrio nel mercato:",
    options: ["Del lavoro", "Dei beni e servizi", "Della valuta estera", "Delle materie prime"],
    answer: 1,
    explanation: "IS deriva da investment-saving e rappresenta il lato reale della spesa."
  },
  {
    id: 19,
    type: "mcq",
    question: "In un'economia aperta, NX indica:",
    options: ["Nuovi investimenti", "Esportazioni nette", "Domanda nazionale", "Capitale naturale"],
    answer: 1,
    explanation: "NX è la differenza tra esportazioni e importazioni."
  },
  {
    id: 20,
    type: "mcq",
    question: "Tra i motori della crescita di lungo periodo troviamo:",
    options: ["Solo il consumo presente", "Capitale umano, capitale fisico e tecnologia", "Solo la spesa pubblica", "Solo il tasso di cambio"],
    answer: 1,
    explanation: "Sono i tre pilastri richiamati negli appunti."
  },
  {
    id: 21,
    type: "mcq",
    question: "Gli effetti di rete diretti significano che:",
    options: ["Il valore della rete cala quando entrano utenti", "Il valore aumenta con il numero di utenti", "La rete dipende solo dal prezzo", "Sono identici all'inflazione"],
    answer: 1,
    explanation: "Più nodi partecipano, più è utile far parte della rete."
  }
];
...
export const openQuestions = [
  {
    id: "a1",
    title: "Spiega graficamente equilibrio, penuria ed eccedenza",
    prompt:
      "Parti dal grafico domanda-offerta e spiega cosa succede quando il prezzo si trova sotto o sopra l'equilibrio. Devi nominare assi, curve, punto di equilibrio e aggiustamento dei prezzi.",
    checklist: [
      "Assi corretti: Q orizzontale, P verticale.",
      "Definizione delle curve D e S.",
      "Incrocio come equilibrio.",
      "Prezzo sotto P*: penuria, D > S.",
      "Prezzo sopra P*: eccedenza, S > D.",
      "Ruolo del prezzo come segnale e incentivo."
    ]
  },
  {
    id: "a2",
    title: "Spiega la scelta ottima del consumatore",
    prompt:
      "Descrivi come un consumatore razionale sceglie il paniere ottimo usando curve di indifferenza e retta di bilancio. Inserisci l'effetto di una variazione del reddito o del prezzo di un bene.",
    checklist: [
      "Preferenze e curve di indifferenza.",
      "Vincolo di bilancio con intercette R/Px e R/Py.",
      "Tangenza come ottimo interno.",
      "Rotazione se cambia un prezzo.",
      "Spostamento parallelo se cambia il reddito."
    ]
  },
  {
    id: "a3",
    title: "Confronta concorrenza perfetta e monopolio",
    prompt:
      "Metti a confronto le due forme di mercato partendo dalla regola di massimizzazione del profitto e arrivando alle differenze su prezzo, quantità e benessere.",
    checklist: [
      "In concorrenza perfetta: price-taker, P = RM = R'.",
      "Scelta ottima: P = MC in concorrenza.",
      "In monopolio: domanda decrescente e MR sotto D.",
      "Scelta ottima: MR = MC e prezzo letto sulla domanda.",
      "Prezzo più alto e quantità più bassa in monopolio.",
      "Richiamo a potere di mercato e perdita di benessere."
    ]
  }
];
